...
public class CountryList
{
    ...
    public ArrayList<Country> filterCountry (CheckCountry test){
        ...
        ans.sort((c1, c2) -> c1.getName().compareToIgnoreCase(c2.getName()));
        return ans;
    }
    public Country maxPopulation (){
        Country ans = countryList.get(0);
        long max = countryList.get(0).getPopulation();
        for (Country e: countryList) {
